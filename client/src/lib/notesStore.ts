/**
 * Per-lesson notes stored in localStorage under "algosphere-notes:<chapterId>/<lessonId>".
 * A parallel "algosphere-notes-meta" map keeps an updatedAt timestamp per note so
 * cloud sync can resolve conflicts newest-wins. Used by LessonNotes, the global
 * /notes page, and the sync layer.
 */

export const NOTE_PREFIX = "algosphere-notes:";
const META_KEY = "algosphere-notes-meta";
