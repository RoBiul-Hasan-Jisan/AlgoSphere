...
const TO_EMAIL = "robiulhasanjisan88@gmail.com";
...
export function IssuePage() {
  ...
  const fullSubject = `[Algosphere · ${kindLabel}] ${subject || "(no subject)"}`;
...
User-Agent: ${navigator.userAgent}`;
    ...
    return (
      <div className="mx-auto max-w-xl px-5 py-24 text-center">
        ...
        <p className="mt-3 text-muted">
          Your email app should have opened — just hit send.
        </p>
  ...
  return (
    <div className="mx-auto max-w-xl px-5 py-12 sm:px-6">
      ...
      <p className="mt-3 text-muted">
        Found a bug or idea? Send it directly via email.
      </p>
